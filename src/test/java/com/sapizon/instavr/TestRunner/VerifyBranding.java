...
import com.sapizon.instavr.test.T003_Test_Verify_Branding;

public class VerifyBranding {
	...
	public static void main(String[] args) {
		...
		XmlClass publicTestClass = new XmlClass(T003_Test_Verify_Branding.class);
