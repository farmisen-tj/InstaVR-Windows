...
import com.sapizon.instavr.test.T010_Test_Upload_image_verify_offset;

public class ResetCamara {
	...
	public static void main(String[] args) {
		...
		XmlClass publicTestClass = new XmlClass(T010_Test_Upload_image_verify_offset.class);
