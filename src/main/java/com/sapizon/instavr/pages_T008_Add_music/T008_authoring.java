...
import com.sapizon.instavr.pages_T009_Update_new_image.T009_add_image;

public class T008_authoring {


	WebDriver driver;
	public T008_authoring(WebDriver driver) throws IOException{
		this.driver=driver;
