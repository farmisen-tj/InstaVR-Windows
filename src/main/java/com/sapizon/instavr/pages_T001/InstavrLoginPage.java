...
public class InstavrLoginPage {
public static final Logger log = Logger.getLogger(InstavrLoginPage.class.getName());
	
	WebDriver driver;
	public InstavrLoginPage(WebDriver driver) {
	this.driver = driver;
}
	...
	public InstaVR_Logout dologin(String username, String password){
